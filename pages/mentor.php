...
<meta charset="UTF-8">
  ...
  <title>Mentor - Energy Space</title>
  <meta charset="utf-8">
...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../assets/img/mentor/12ae07_26b86a454b264979a74a29c4cbd86586_mv2.jpg" alt="Los Angeles" class="d-block w-100 ">
    </div>
    <div class="carousel-item">
      <img src="../assets/img/mentor/12ae07_cdcc8cf661f54a1a96340a4f079c3741_mv2.png" alt="Chicago" class="d-block w-100">
    </div>
    <div class="carousel-item">
      <img src="../assets/img/mentor/12ae07_26b86a454b264979a74a29c4cbd86586_mv2.jpg" alt="New York" class="d-block w-100">
    </div>
  </div>
...
<div class="container" > 
              <div class="text-center mb-0 bac"  >
                    <h1 class="text-light bg-primary" >PARTICIPEZ AU SUCCÈS DE NOS ENTREPRENEUR.E.S</h1>
              </div>
                <div>
...
​                    </p>
                ...
                <div class="text-center mb-0 bac">
                    <h1 class="text-light bg-primary" >EN SAVOIR PLUS SUR LE ROLE DE MENTOR</h1>
                </div> <br>
                <div class="container" > 
                     <div class="text-center mb-0 bac  " >
                      <h1 class="text-light bg-primary" > DEVENEZ MENTOR : 
